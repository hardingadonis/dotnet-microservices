namespace Ordering.API.Swagger
{
    public class ConfigureSwaggerGenOptions : IConfigureNamedOptions<SwaggerGenOptions>
    {
        ...
        {
            var contactUrl = _configuration["Ordering.API.Settings:ContactUrl"];
            var licenseUrl = _configuration["Ordering.API.Settings:LicenseUrl"];

            var info = new OpenApiInfo()
            {
                Title = $"Ordering.API v{description.ApiVersion}",
